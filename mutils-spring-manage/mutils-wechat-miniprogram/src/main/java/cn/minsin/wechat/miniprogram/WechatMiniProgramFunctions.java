...
import cn.minsin.wechat.miniprogram.model.*;
...
public class WechatMiniProgramFunctions extends WeChatPayFunctions {
	...
	private static final MutilsWechatMiniProgramProperties properties;

    static {
        properties = AbstractConfig.loadConfig(MutilsWechatMiniProgramProperties.class);
	...
	public static Code2SessionReturnModel jscode2session(String code) throws ClientProtocolException, IOException {
		...
		try {
			...
			LOGGER.info("Code2SessionReturnModel string is {}", string);
	...
	public static UserInfoModel getUserInfo(String encryptedData, String code, String iv)
		...
		String result = new String(resultByte, CharSetConstant.UTF_8);
	...
	public static Map<String, String> createMiniProgramPayParamter(MiniProgramOrderPayModel model)
			throws ParseException, IOException, MutilsErrorException, JDOMException {
	...
	public static RefundReturnModel createMiniProgramRefundParamter(MiniProgramRefundModel model)
			throws ClientProtocolException, JDOMException, IOException, MutilsErrorException {
	 ...
	 * @throws MutilsErrorException
	 */
	public static InputStream getMiniProgramQrCode(MiniProgramCodeModel model)
